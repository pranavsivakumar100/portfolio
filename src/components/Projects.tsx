...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Beautiful weather dashboard with interactive maps, detailed forecasts, and location-based weather alerts using multiple APIs.",
          ...
          {projects.map((project, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-white border-0 shadow-lg">
              ...
              <CardFooter className="flex gap-3">
                <Button variant="outline" size="sm" className="flex-1 group-hover:border-purple-500 group-hover:text-purple-500 transition-colors">
